            ...
            if (currentStep === 'COMPLETED') {
                ...
                switch (currentStep) {
                    ...
                    case 'STEP_6':
                        ...
                        nextQuestion = `*ШАГ 7 из 9: Преодоление*\n\nПланировать нужно не только результаты, но и возможные провалы. Как ты думаешь, что может помешать тебе выполнить привычку?\n\n*Напиши одно самое вероятное препятствие* и *твои действия*, если оно возникнет. *Используй формат "если... то..."*. \n\n_Например_: _если устану, сделаю отжимание сразу, как приду домой_.`;
                        break;
                    case 'STEP_7':
                        ...
                        nextQuestion = `*ШАГ 8 из 9: Пропуски*\n\nЭто очень важное правило: *никогда не пропускай привычку больше одного раза подряд!*.\n\nНапиши, как ты гарантированно вернешься к привычке после одного пропуска? \n\n_Например_: \_сделаю привычку сразу же, как вспомню, независимо от времени\_.`;
                        break;
                    case 'STEP_8':
