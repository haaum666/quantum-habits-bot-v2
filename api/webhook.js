    ...
    try {
        ...
        // ===============================================
            ...
            if (currentStep === 'COMPLETED') {
                ...
                // Обработка кнопок
                // ВАЖНО: Текст кнопок и команд здесь не форматируется!
                ...
                switch (currentStep) {
                    case 'STEP_1':
                        ...
                        // ИСПРАВЛЕНО: Форматирование на *жирный*
                    ...
                    case 'STEP_2':
                        ...
                        // ИСПРАВЛЕНО: Убрана нумерация "Правило 3:"
                    ...
                    case 'STEP_7':
                        ...
                        nextQuestion = `*ШАГ 8 из 9: Правило при пропуске*\n\nЭто самое главное правило: *никогда не пропускай привычку дважды подряд*.\n\n*Напиши, как ты гарантированно вернешься к привычке после одного пропуска* (например: _Начну со второй половины дня_, _Сделаю ее сразу же, как вспомню, независимо от времени_).`;
                        break;
                    case 'STEP_8':
