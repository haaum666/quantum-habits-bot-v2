            ...
            if (currentStep === 'COMPLETED') {
                ...
                switch (currentStep) {
                    ...
                    case 'STEP_6':
                        ...
                        nextQuestion = "*ШАГ 7 из 10: Провалы*\n\nПланировать нужно не только результаты, но и возможные провалы. Как ты думаешь, что может помешать тебе выполнить привычку?\n\n*Напиши одно самое вероятное препятствие*. \n\nНапример: \_усталость после работы\, \_забуду о привычке_\, \_не хватит времени_\).";
                        break;
                    case 'STEP_7':
                        updatePayload = { obstacle_plan_1: textToSave, onboarding_state: 'STEP_8' };
                        confirmationMessage = `✅ Принято! Препятствие определено: *${textToSave}*.`;
                        
                        // Обновленный текст Шага 8
                        nextQuestion = `*ШАГ 8 из 10: Преодоление*\n\nТвое препятствие: *«${textToSave}»*.\n\nНапиши, какими будут *твои действия*, если оно возникнет? \n\nНапример: _если устану, сделаю отжимание сразу, как приду домой_, _поставлю будильник, что бы не забыть_.`;
                        break;
                    case 'STEP_8':
                        updatePayload = { obstacle_plan_2: textToSave, onboarding_state: 'STEP_9' };
                        // Обновленное подтверждение Шага 8
                        confirmationMessage = `✅ Принято! План преодоления: *${textToSave}*.`;
                    ...
                    case 'STEP_9':
                        ...
                        confirmationMessage = `Правило при пропуске: *${textToSave}*.\n\nЭто защищает тебя от срыва. \n\nОдин пропуск - случайность. \n\nДва - начало новой, плохой привычки.`;
