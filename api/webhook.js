            ...
            if (currentStep === 'COMPLETED') {
                ...
                switch (currentStep) {
                    ...
                    case 'STEP_3':
                        ...
                        // ИСПРАВЛЕНО: Убрано нижнее подчеркивание в цикле, оставлено жирным
                    ...
                    case 'STEP_4':
                        ...
                        // ИСПРАВЛЕНО: Новая формулировка 1 и 2
                    ...
                    case 'STEP_6':
                        ...
                        // ИСПРАВЛЕНО: Пунктуация, удален КАПС
                    ...
                    case 'STEP_7':
                        ...
                        // ИСПРАВЛЕНО: Удалена фраза "Ты подготовил себя к успеху!"
                        confirmationMessage = `✅ Принято! План преодоления зафиксирован: *${textToSave}*.\n\n`; 
                        
                        // ИСПРАВЛЕНО: Изменена формулировка правила
                    ...
                    case 'STEP_8':
                        ...
                        // ИСПРАВЛЕНО: Разделение вопроса и примера на разные строки с курсивом
                    ...
                    case 'STEP_9':
                        ...
                        // ИСПРАВЛЕНО: Добавлено "каждый день", изменено форматирование формулы, добавлены слова в поля
