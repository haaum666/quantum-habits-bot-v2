...
export default async (request, response) => {
    ...
    try {
        ...
        if (isStartCommand || !userData) {
            ...
            const welcomeMessage = `🧠 Привет, *${userFirstName}*. Ты в системе *Квантумных Привычек*.\n\nДаже самое длинное путешествие начинается с подготовки. Твой первый шаг — понять, *Каким человеком ты хочешь стать*?`;
            ...
            if (currentStep === 'COMPLETED') {
                ...
                switch (currentStep) {
                    ...
                    case 'STEP_2':
                        ...
                        nextQuestion = `*ШАГ 3 из 10: Триггер.*\n\nЛучший способ начать что-то новое — *встроить* это во что-то уже существующее. Мы используем *Связывание привычек* (Habit Stacking).\n\nНапиши, какое ежедневное действие послужит *триггером* для твоей микро-привычки (например: \_После того, как выключу будильник_\, \_После того, как почищу зубы_\, \_После того, как проверю соцсети_\).`;
                        break;
                    case 'STEP_3':
